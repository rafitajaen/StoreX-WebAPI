...
public class StoreProduct : AuditableEntity, IAggregateRoot
{
    ...
    public StoreProduct(Guid id, string name, string? description, decimal basePrice, int stockUnits, string? unitType, decimal m2, string? imagePath)
    {
        Id = id;
        Name = name;
    ...
    public StoreProduct(string name, string? description, decimal basePrice, int stockUnits, string? unitType, decimal m2, string? imagePath)
    {
        Name = name;
        Description = description;
        BasePrice = basePrice;
    ...
    public StoreProduct Update(string name, string? description, decimal? basePrice, int? stockUnits, string? unitType, decimal? m2, string? imagePath)
    {
